...
.method public constructor <init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Ljava/util/concurrent/Executor;)V
    ...
    .line 70
    new-instance v0, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$Ej_FjUiWBzvsopQiC01iY8bGhEE;

    invoke-direct {v0, p0}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$Ej_FjUiWBzvsopQiC01iY8bGhEE;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;)V
...
.method public addCaptureRequestOptions(Landroidx/camera/camera2/interop/CaptureRequestOptions;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 193
    new-instance p1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$uHiAZouT-3Q8e-stWfIHpIz4h2g;

    invoke-direct {p1, p0}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$uHiAZouT-3Q8e-stWfIHpIz4h2g;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;)V
...
.method public clearCaptureRequestOptions()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 231
    new-instance v0, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$O4cQVoLw89YaQuDKiX0-SWbWr6s;

    invoke-direct {v0, p0}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$O4cQVoLw89YaQuDKiX0-SWbWr6s;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;)V
...
.method public synthetic lambda$addCaptureRequestOptions$3$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public synthetic lambda$addCaptureRequestOptions$4$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    ...
    new-instance v1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$0Geq9yBRpsk2XE-aJAYzQLA1wFo;

    invoke-direct {v1, p0, p1}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$0Geq9yBRpsk2XE-aJAYzQLA1wFo;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method public synthetic lambda$clearCaptureRequestOptions$5$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public synthetic lambda$clearCaptureRequestOptions$6$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    new-instance v1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$-bfF7koqT_RE4w_v_wxu-mVzdoo;

    invoke-direct {v1, p0, p1}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$-bfF7koqT_RE4w_v_wxu-mVzdoo;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method public synthetic lambda$new$0$Camera2CameraControl(Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 2
...
.method public synthetic lambda$setActive$7$Camera2CameraControl(Z)V
    .locals 0
...
.method public synthetic lambda$setCaptureRequestOptions$1$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public synthetic lambda$setCaptureRequestOptions$2$Camera2CameraControl(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    new-instance v1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$03H6FlkJXzTF6ZDjgwOmh7aCazo;

    invoke-direct {v1, p0, p1}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$03H6FlkJXzTF6ZDjgwOmh7aCazo;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method public setActive(Z)V
    ...
    new-instance v1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$eXOXUu1O59eAmtGj68tmkRQkY38;

    invoke-direct {v1, p0, p1}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$eXOXUu1O59eAmtGj68tmkRQkY38;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;Z)V
...
.method public setCaptureRequestOptions(Landroidx/camera/camera2/interop/CaptureRequestOptions;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 161
    new-instance p1, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$R5fFSEspm7GKy93ZlTS54nSpA2I;

    invoke-direct {p1, p0}, Landroidx/camera/camera2/interop/-$$Lambda$Camera2CameraControl$R5fFSEspm7GKy93ZlTS54nSpA2I;-><init>(Landroidx/camera/camera2/interop/Camera2CameraControl;)V
