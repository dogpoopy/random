...
.method public static final readBytes(Ljava/io/File;)[B
    ...
    .line 70
    invoke-virtual {v1, v2, v5, v3}, Ljava/io/FileInputStream;->read([BII)I
    ...
    .line 84
    :cond_2
    new-instance v5, Lkotlin/io/ExposingBufferByteArrayOutputStream;

    const/16 v9, 0x2001

    invoke-direct {v5, v9}, Lkotlin/io/ExposingBufferByteArrayOutputStream;-><init>(I)V

    .line 85
    invoke-virtual {v5, v3}, Lkotlin/io/ExposingBufferByteArrayOutputStream;->write(I)V
    ...
    invoke-static {v1, v3, v4, v9, v8}, Lkotlin/io/ByteStreamsKt;->copyTo$default(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J

    .line 88
    array-length v1, v2

    invoke-virtual {v5}, Lkotlin/io/ExposingBufferByteArrayOutputStream;->size()I
    ...
    .line 91
    invoke-virtual {v5}, Lkotlin/io/ExposingBufferByteArrayOutputStream;->getBuffer()[B
