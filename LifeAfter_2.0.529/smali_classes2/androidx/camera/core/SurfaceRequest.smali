...
.method public constructor <init>(Landroid/util/Size;Landroidx/camera/core/impl/CameraInternal;Landroidx/camera/core/DynamicRange;Landroid/util/Range;Ljava/lang/Runnable;)V
    ...
    .line 179
    new-instance v0, Landroidx/camera/core/-$$Lambda$SurfaceRequest$aBej7HDLh-OXtFkhhJqwnMya-w4;

    invoke-direct {v0, p3, p2}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$aBej7HDLh-OXtFkhhJqwnMya-w4;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/String;)V
    ...
    .line 192
    new-instance v2, Landroidx/camera/core/-$$Lambda$SurfaceRequest$btaCbh-R1GUdl6ecPEzVyFFTQT0;

    invoke-direct {v2, v1, p2}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$btaCbh-R1GUdl6ecPEzVyFFTQT0;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/String;)V
    ...
    .line 225
    new-instance p4, Landroidx/camera/core/-$$Lambda$SurfaceRequest$WWsQ783Y628yCYG-TL8JC-KqsM4;

    invoke-direct {p4, v0, p2}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$WWsQ783Y628yCYG-TL8JC-KqsM4;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/String;)V
    ...
    .line 279
    new-instance p2, Landroidx/camera/core/-$$Lambda$SurfaceRequest$VEa_ntChyl08DUZIPJD7_G6fNI0;

    invoke-direct {p2, p0}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$VEa_ntChyl08DUZIPJD7_G6fNI0;-><init>(Landroidx/camera/core/SurfaceRequest;)V
...
.method private initialSurfaceRecreationCompleter(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;)Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
    ...
    .line 483
    new-instance v1, Landroidx/camera/core/-$$Lambda$SurfaceRequest$FKvdq84b8QBj8wL4YX_K8_5uALI;

    invoke-direct {v1, p0, v0}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$FKvdq84b8QBj8wL4YX_K8_5uALI;-><init>(Landroidx/camera/core/SurfaceRequest;Ljava/util/concurrent/atomic/AtomicReference;)V
...
.method public synthetic lambda$initialSurfaceRecreationCompleter$6$SurfaceRequest(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public provideSurface(Landroid/view/Surface;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    .line 433
    new-instance v0, Landroidx/camera/core/-$$Lambda$SurfaceRequest$5-vkwtq5rrXTwajM8RYtCZdBIQk;

    invoke-direct {v0, p3, p1}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$5-vkwtq5rrXTwajM8RYtCZdBIQk;-><init>(Landroidx/core/util/Consumer;Landroid/view/Surface;)V
    ...
    .line 437
    :catch_0
    new-instance v0, Landroidx/camera/core/-$$Lambda$SurfaceRequest$LxT2LRdxcQOvSLUIsyR5L3AElno;

    invoke-direct {v0, p3, p1}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$LxT2LRdxcQOvSLUIsyR5L3AElno;-><init>(Landroidx/core/util/Consumer;Landroid/view/Surface;)V
...
.method public setTransformationInfoListener(Ljava/util/concurrent/Executor;Landroidx/camera/core/SurfaceRequest$TransformationInfoListener;)V
    ...
    .line 612
    new-instance v0, Landroidx/camera/core/-$$Lambda$SurfaceRequest$FJkiZk3uBqaxXa0TGNdmbpMe-g4;

    invoke-direct {v0, p2, v1}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$FJkiZk3uBqaxXa0TGNdmbpMe-g4;-><init>(Landroidx/camera/core/SurfaceRequest$TransformationInfoListener;Landroidx/camera/core/SurfaceRequest$TransformationInfo;)V
...
.method public updateTransformationInfo(Landroidx/camera/core/SurfaceRequest$TransformationInfo;)V
    ...
    .line 587
    new-instance v0, Landroidx/camera/core/-$$Lambda$SurfaceRequest$w9fBlbncoAHyCD1-vY0OjBU2kyU;

    invoke-direct {v0, v1, p1}, Landroidx/camera/core/-$$Lambda$SurfaceRequest$w9fBlbncoAHyCD1-vY0OjBU2kyU;-><init>(Landroidx/camera/core/SurfaceRequest$TransformationInfoListener;Landroidx/camera/core/SurfaceRequest$TransformationInfo;)V
