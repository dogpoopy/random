...
.method executeCapture(Ljava/util/List;I)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v1, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$eezOQdir929JivL2kgvc1dQlmHQ;

    invoke-direct {v1, p0, p2}, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$eezOQdir929JivL2kgvc1dQlmHQ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;I)V
    ...
    new-instance v1, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$8k2DMyHSvToSYpVOkKxfnNXGdrU;

    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$8k2DMyHSvToSYpVOkKxfnNXGdrU;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    ...
    new-instance v1, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$KNmGpbt3fXz1x_k8kDoeXNJLgMI;

    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$KNmGpbt3fXz1x_k8kDoeXNJLgMI;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/util/List;I)V
    ...
    new-instance v0, Landroidx/camera/camera2/internal/-$$Lambda$MQGWf2RindOwW_94BKDZ9EEVVs8;

    invoke-direct {v0, p2}, Landroidx/camera/camera2/internal/-$$Lambda$MQGWf2RindOwW_94BKDZ9EEVVs8;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$PipelineTask;)V
...
.method public synthetic lambda$executeCapture$0$Camera2CapturePipeline$Pipeline(ILandroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 2
...
.method public synthetic lambda$executeCapture$2$Camera2CapturePipeline$Pipeline(Ljava/lang/Boolean;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    sget-object v2, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$xPeoOwNjfyi210rIorXzAW5Aryo;->INSTANCE:Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$xPeoOwNjfyi210rIorXzAW5Aryo;
...
.method public synthetic lambda$executeCapture$3$Camera2CapturePipeline$Pipeline(Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public synthetic lambda$submitConfigsInternal$4$Camera2CapturePipeline$Pipeline(Landroidx/camera/core/impl/CaptureConfig$Builder;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method submitConfigsInternal(Ljava/util/List;I)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 354
    :cond_3
    new-instance v2, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$-R4NSnBjxnyg4rO9qnl7Cr7Hg2g;

    invoke-direct {v2, p0, v3}, Landroidx/camera/camera2/internal/-$$Lambda$Camera2CapturePipeline$Pipeline$-R4NSnBjxnyg4rO9qnl7Cr7Hg2g;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroidx/camera/core/impl/CaptureConfig$Builder;)V
