...
.method public bindViewToPosition(Landroid/view/View;I)V
    ...
    .line 4315
    iput-object v0, p1, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mViewHolder:Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method getScrapViewForPosition(IIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView$State;->access$2200(Landroid/support/v7/widget/RecyclerView$State;)Z
    ...
    .line 4815
    invoke-virtual {v4, p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    .line 4825
    invoke-static {p2}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object p1

    .line 4826
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->this$0:Landroid/support/v7/widget/RecyclerView;

    iget-object p3, p3, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/ChildHelper;

    invoke-virtual {p3, p2}, Landroid/support/v7/widget/ChildHelper;->unhide(Landroid/view/View;)V
    ...
    invoke-virtual {p3, p2}, Landroid/support/v7/widget/ChildHelper;->indexOfChild(Landroid/view/View;)I
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/widget/ChildHelper;->detachViewFromParent(I)V

    .line 4833
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/RecyclerView$Recycler;->scrapView(Landroid/view/View;)V
    ...
    .line 4841
    :cond_5
    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->mCachedViews:Ljava/util/ArrayList;
...
.method getViewForPosition(IZ)Landroid/view/View;
    ...
    invoke-virtual {v5, v1}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemViewType(I)I
    ...
    .line 4416
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    .line 4420
    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->mViewCacheExtension:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;

    if-eqz p2, :cond_a

    .line 4423
    invoke-virtual {p2, p0, p1, v5}, Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;->getViewForPositionAndType(Landroid/support/v7/widget/RecyclerView$Recycler;II)Landroid/view/View;
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p2, v5}, Landroid/support/v7/widget/RecyclerView$RecycledViewPool;->getRecycledView(I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 4446
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->resetInternal()V
    ...
    .line 4448
    invoke-direct {p0, p2}, Landroid/support/v7/widget/RecyclerView$Recycler;->invalidateDisplayListInt(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p2, v0, v5}, Landroid/support/v7/widget/RecyclerView$Adapter;->createViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->hasAnyOfTheFlags(I)Z
    ...
    .line 4465
    invoke-virtual {v0, v3, p2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->setFlags(II)V
    ...
    invoke-static {p2}, Landroid/support/v7/widget/RecyclerView$State;->access$2300(Landroid/support/v7/widget/RecyclerView$State;)Z
    ...
    .line 4467
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->buildAdapterChangeFlagsForAnimations(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getUnmodifiedPayloads()Ljava/util/List;

    move-result-object v6

    invoke-virtual {v1, v5, v0, p2, v6}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->recordPreLayoutInformation(Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/RecyclerView$ViewHolder;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    invoke-static {v1, v0, p2}, Landroid/support/v7/widget/RecyclerView;->access$4500(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    .line 4479
    iput p1, v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mPreLayoutPosition:I
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->mAdapterHelper:Landroid/support/v7/widget/AdapterHelper;

    invoke-virtual {p2, p1}, Landroid/support/v7/widget/AdapterHelper;->findPositionOffset(I)I
    ...
    iput-object v1, v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mOwnerRecyclerView:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v1, v0, p2}, Landroid/support/v7/widget/RecyclerView$Adapter;->bindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {v1, p2}, Landroid/support/v7/widget/RecyclerView;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    invoke-virtual {v1, p2}, Landroid/support/v7/widget/RecyclerView;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 4506
    :goto_8
    iput-object v0, p2, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mViewHolder:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 4507
    :goto_9
    iput-boolean v2, p2, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mPendingInvalidate:Z
...
.method scrapView(Landroid/view/View;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v7/widget/RecyclerView;->access$5000(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
